                ...
                <SwiperSlide
                  ...
                  <a
                    ...
                    <div className="absolute right-[50px] bottom-[50px] bg-yellow-100 font-medium mr-2 px-2.5 py-0.5 rounded-lg h-16">
                      ...
                      <span className="absolute right-8 bottom-2 justify-end  text-yellow-800 font-bold rounded-lg text-xs  mr-2 px-2.5 py-0.5 ">
                        Rating
                      </span>
                      <span className="absolute right-0 bottom-2 justify-end bg-purple-900 text-white rounded-lg text-xs font-medium mr-2 px-2.5 py-0.5">
